...
public class InsAndDelBookInterFrm extends JInternalFrame {
	...
	public InsAndDelBookInterFrm() {
		...
		btnNewButton.setIcon(new ImageIcon(InsAndDelBookInterFrm.class.getResource("/images/search+20.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(InsAndDelBookInterFrm.class.getResource("/images/delete+20.png")));
		...
		btnNewButton_2.setIcon(new ImageIcon(InsAndDelBookInterFrm.class.getResource("/images/edit+20.png")));
